...
import { Dumbbell, Store, Coffee, CreditCard, Users, BarChart3, Shield, Smartphone } from 'lucide-react';
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 py-20 relative">
          <div className="text-center">
            ...
            <h1 className="font-display text-5xl sm:text-7xl text-[#F8F8F2] tracking-wider mb-4">ORGANA</h1>
